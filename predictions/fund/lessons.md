---
version: 1
last_updated: '2026-06-16T01:34:31Z'
total_ticks_recorded: 171
...
- **[good_rejection]** High-conviction MA-Pessimist (<=-0.50) on rejected symbols is a MODEST directional veto: full-population audit (n=147, +6 fwd) shows 56% fell / mean -2.27%, justified by favorable asymmetry (-7.0% when right vs +3.9% when wrong = +2.27%/event protective EV) — NOT the early "8/8"   _(supports=148, disconfirms=1)_
